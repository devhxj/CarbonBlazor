 ...
 * LICENSE file in the root directory of this source tree.
 */
let g,b,u;!function(o){o.MINI="mini",o.EXTRA_EXTRA_SMALL="2xs",o.EXTRA_SMALL="xs",o.SMALL="sm",o.MEDIUM="md",o.LARGE="lg",o.EXTRA_LARGE="xl"}(g||(g={})),function(o){o.DEFAULT="",o.HOLLOW="hollow",o.INLINE="inline"}(b||(b={})),function(o){o.DEFAULT="",o.HOLLOW="hollow"}(u||(u={}));let f,m,y,_,x,k,z=o=>o;e([a(`${c}-slug`)],(function(o,e){class i extends e{constructor(...t){super(...t),o(this)}}return{F:i,d:[{kind:"field",decorators:[p({reflect:!0})],key:"slot",value:()=>"slug"},{kind:"field",decorators:[p({attribute:"ai-text"})],key:"aiText",value:()=>"AI"},{kind:"field",decorators:[p({attribute:"ai-text-label"})],key:"aiTextLabel",value:()=>""},{kind:"field",decorators:[p({reflect:!0,attribute:"dot-type"})],key:"dotType",value:()=>u.DEFAULT},{kind:"field",decorators:[p({reflect:!0})],key:"kind",value:()=>b.DEFAULT},{kind:"field",decorators:[p({type:Boolean,attribute:"revert-active"})],key:"revertActive",value:()=>!1},{kind:"field",decorators:[p({attribute:"revert-label"})],key:"revertLabel",value:()=>"Revert to AI input"},{kind:"field",decorators:[p({reflect:!0})],key:"size",value:()=>g.EXTRA_SMALL},{kind:"field",decorators:[p({attribute:"slug-label"})],key:"slugLabel",value:()=>"Show information"},{kind:"field",decorators:[p()],key:"previousValue",value:void 0},{kind:"field",key:"_handleClick",value(){return()=>{this.revertActive?(this.revertActive=!1,this.removeAttribute("revert-active")):this.open=!this.open}}},{kind:"field",key:"_renderToggleTipLabel",value:()=>()=>s(f||(f=z``))},{kind:"field",key:"_renderTooltipButton",value(){return()=>{const{size:o,kind:t,aiText:e,aiTextLabel:r,slugLabel:d}=this,p=`${e} - ${d}`,i=n({[`${c}--toggletip-button`]:!0,[`${c}--slug__button`]:!0,[`${c}--slug__button--${o}`]:o,[`${c}--slug__button--${t}`]:t,[`${c}--slug__button--inline-with-content`]:t===b.INLINE&&r});return s(m||(m=z`
      <button
        aria-controls="${0}"
        @click="${0}"
        class=${0}
    ...
    `),this.id,this._handleClick,i,p,c,e,r&&t===b.INLINE?s(y||(y=z`
              <span class="${0}--slug__additional-text">
                ${0}
              </span>
            `),c,r):"")}}},{kind:"field",key:"_renderInnerContent",value(){return()=>{const{revertActive:o,revertLabel:e}=this;return s(_||(_=z`
      ${0}
    `),o?s(x||(x=z`
            <cds-icon-button
              kind="ghost"
          ...
          `),this._handleClick,e,(({children:o,...e}={})=>t`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${l(e)}" aria-hidden="true" width="16" height="16" viewBox="0 0 32 32">${o}${o}<path d="M20,10H7.8149l3.5874-3.5859L10,5,4,11,10,17l1.4023-1.4146L7.8179,12H20a6,6,0,0,1,0,12H12v2h8a8,8,0,0,0,0-16Z"></path></svg>`)({slot:"icon"})):s(k||(k=z`
            ${0} ${0}
          `),this._renderTooltipButton(),this._renderTooltipContent()))}}},{kind:"method",key:"updated",value:function(o){r(d(i.prototype),"updated",this).call(this,o),this.kind!==b.HOLLOW&&this.dotType!==u.HOLLOW?this.setAttribute("enabled",""):this.removeAttribute("enabled")}},{kind:"field",static:!0,key:"styles",value:()=>h}]}}),i),e([a(`${c}-slug-action-button`)],(function(o,t){return{F:class extends t{constructor(...t){super(...t),o(this)}},d:[{kind:"field",decorators:[p({reflect:!0})],key:"slot",value:()=>"actions"},{kind:"field",static:!0,key:"styles",value:()=>h}]}}),v);
