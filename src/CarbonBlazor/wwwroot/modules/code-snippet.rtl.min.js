...
import{_ as e}from"./objectSpread2-ea408269.js";import{T as t,i as s,_ as o,p as n,x as i,s as c}from"./settings-daf72103.js";import{_ as d,a as r}from"./get-d229c408.js";import{e as a,i as p,t as l}from"./directive-e2d48b9c.js";import{n as b}from"./query-assigned-elements-8e88277c.js";import{s as v}from"./16-c0c1a32f.js";import{F as h}from"./focus-e79b2a40.js";import"./shared-enums-c6fe8c39.js";import"./copy-button-e1f89efb.js";import"./button-499b2921.js";import{c as f}from"./carbon-element-4ca9803f.js";import"./spread-eaa3f2b9.js";import"./custom-element-975be15f.js";import"./icon-button-88446de4.js";import"./tooltip-content-6a832657.js";import"./host-listener-42fdb22d.js";import"./on-6c264d49.js";import"./popover-content-08984bac.js";import"./class-map-0ae732f6.js";import"./button-set-2756dc35.js";import"./button-skeleton-e9a7f2ed.js";import"./if-defined-5b102a7a.js";
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const u="important",m=" !"+u,y=a(class extends p{constructor(e){var t;if(super(e),e.type!==l.ATTRIBUTE||"style"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,s)=>{const o=e[s];return null==o?t:t+`${s=s.includes("-")?s:s.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${o};`}),"")}update(e,[s]){const{style:o}=e.element;if(void 0===this.ut){this.ut=new Set;for(const e in s)this.ut.add(e);return this.render(s)}this.ut.forEach((e=>{null==s[e]&&(this.ut.delete(e),e.includes("-")?o.removeProperty(e):o[e]="")}));for(const e in s){const t=s[e];if(null!=t){this.ut.add(e);const s="string"==typeof t&&t.endsWith(m);e.includes("-")||s?o.setProperty(e,s?t.slice(0,-11):t,s?u:""):o[e]=t}}return t}});
/**
 * @license
 *
